...
public class CustomSuggestionsProvider extends ContentProvider {
    ...
    private static final String RESOURCE_PREFIX = "android.resource://github.madmarty.madsonic/";
    ...
    private SearchResult search(String query) {
        ...
        try {
            return musicService.search(new SearchCritera(query, 5, 10, 15), getContext(), null);
        } catch (Exception e) {
            return null;
        }
    }
