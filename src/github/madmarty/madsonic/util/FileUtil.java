...
public class FileUtil {
	...
	public static File getPlaylistDirectory() {
		File playlistDir = new File(getMadsonicDirectory(), "playlists");
	...
	public static File getPodcastDirectory(Context context) {
		File dir = new File(getMadsonicDirectory(), "podcasts");
    ...
    private static File createDirectory(String name) {
        File dir = new File(getMadsonicDirectory(), name);
    ...
    public static File getMadsonicDirectory() {
